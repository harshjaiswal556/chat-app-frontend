...
const SideDrawer = () => {
  ...
  return (
    <>
      <Box display={"flex"} justifyContent={"space-between"} alignItems={"center"} bg={"white"} width="100%" padding="5px 10px" borderWidth={"5px"}>
        ...
        <Text fontSize={"2xl"} fontFamily={"Work sans"}>CHAT-WEB-APP</Text>
        <div>
          <Menu>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Box display="flex" paddingBottom="2px">
              <Input placeholder="Search by name or email" marginRight="2px" value={search} onChange={(e)=>setSearch(e.target.value)}/>
